...
SubCategoriesRouter.route('/').get(subCategoriesController_1.getsubCategories).post(subcategoriesValidator_1.createSubcategoryValidator, subCategoriesController_1.createSubCategory);
