...
export const routes: Routes = [
    ...
    },
    {
        ...
        canActivate: [authGuard],
        children: [
            { path: '', title: 'All Coupons', loadComponent: () => import('./coupons/coupons.component').then((m) => m.CouponsComponent) },
            { path: 'create', title: 'create Coupons', loadComponent: () => import('./add-coupon/add-coupon.component').then((m) => m.AddCouponComponent) },
            { path: ':id/update', title: 'update Coupons', loadComponent: () => import('./update-coupon/update-coupon.component').then((m) => m.UpdateCouponComponent) },
        ],
    },
    {
        path: 'orders',
        canActivate: [authGuard],
        children: [{ path: '', title: 'orders', loadComponent: () => import('./orders/orders.component').then((m) => m.OrdersComponent) }],
    },
    {
        path: 'users',
