...
export class UserDetailsComponent implements OnInit, OnDestroy {
    ...
    constructor(private _AuthService: AuthService, private _UserService: UsersService, private _Router: Router, private _ActivatedRoute: ActivatedRoute) {}
    ...
    changeUserPassword(userId: string, formData: FormGroup) {
        this._UserService.updateUserPassword(userId, formData.value).subscribe({
            ...
            error: (err) => {
                if (err) this.changePasswordError = err.error.errors[0].msg;
            },
        });
    }
    ...
    ngOnInit(): void {
        ...
        this.userImage = this._UserService.userImage;
